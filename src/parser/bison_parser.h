...
# define HSQL_TOKENTYPE
  enum hsql_tokentype
  {
    ...
    SQL_NOWAIT = 411,              /* NOWAIT  */
    SQL_SKIP = 412,                /* SKIP  */
    SQL_LOCKED = 413,              /* LOCKED  */
    SQL_SHARE = 414,               /* SHARE  */
    SQL_EQUALS = 415,              /* EQUALS  */
    SQL_NOTEQUALS = 416,           /* NOTEQUALS  */
    SQL_LESS = 417,                /* LESS  */
    SQL_GREATER = 418,             /* GREATER  */
    SQL_LESSEQ = 419,              /* LESSEQ  */
    SQL_GREATEREQ = 420,           /* GREATEREQ  */
    SQL_NOTNULL = 421,             /* NOTNULL  */
    SQL_UMINUS = 422               /* UMINUS  */
  };
