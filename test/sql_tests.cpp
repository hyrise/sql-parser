...
TEST(CreateStatementTest) {
  ...
  ASSERT_EQ(stmt->columns->at(15)->column_constraints->size(), 2);
  ASSERT(stmt->columns->at(15)->column_constraints->at(0) == ConstraintType::Unique);
  ASSERT(stmt->columns->at(15)->column_constraints->at(1) == ConstraintType::PrimaryKey);
  // c_time TIME
  ...
  ASSERT_EQ(stmt->columns->at(19)->nullable, false);
  // c_char_varying CHARACTER VARYING(60)
